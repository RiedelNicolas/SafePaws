export default function Perks({ selected = ["wifi"], onChange = () => { } }) { // Fix parameters
    ...
    return (
        <>
            ...
            <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" checked={selected.includes('mountains')} name="mountains" onChange={handleCheckBoxClick} />
